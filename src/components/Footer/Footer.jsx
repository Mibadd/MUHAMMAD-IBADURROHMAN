        ...
        <footer className="bg-white border-t border-stone-200">
            <div className="container mx-auto px-6 py-8">
                <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
                    <div className="font-sans text-stone-500 mb-4 md:mb-0">
                        <p>
                            &copy; {new Date().getFullYear()} Muhammad Ibadurrohman. All Rights Reserved.
                        </p>
                    </div>
                    ...
                    <div className="flex items-center space-x-6">
                        ...
                        <a
                            href="https://www.linkedin.com/in/muhammadibad/"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="LinkedIn"
                            className="text-stone-500 hover:text-amber-600 transition-colors duration-300"
